...
/**
 * A size based queue wrapping another blocking queue to provide (somewhat
 * relaxed) capacity checks.
 * Mainly makes sense to use with blocking queues that are unbounded to provide
 * the ability to do
 * capacity verification.
 */
public class SizeBlockingQueue<E> extends AbstractQueue<E>
   implements BlockingQueue<E>
{
   ...
   public Iterator<E> iterator() {
      ...
      return new Iterator<E>() {
         ...
         @Override
         public void remove() {
            // note, we can't call #remove on the iterator because we need to
            // know
      ...
      throws InterruptedException
   {
      ...
      throw new IllegalStateException(
         "offer with timeout not allowed on size queue");
   }
