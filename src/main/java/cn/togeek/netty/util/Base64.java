 ...
 * using the
 * {@code #decodeToObject(java.lang.String, int, java.lang.ClassLoader)} method.
 * </li>
...
public class Base64 {
   ...
   public static byte[] encodeBytesToBytes(byte[] source) {
      ...
      try {
         encoded =
            encodeBytesToBytes(source, 0, source.length, Base64.NO_OPTIONS);
      }
      catch(java.io.IOException ex) {
                  ...
                  if(source[i] == EQUALS_SIGN) {
                     ...
                     if(i + 1 < len + off) {
                        throw new java.io.IOException(String.format(Locale.ROOT,
                           "Found equals sign at position %d of the base64 string, not at the end",
                           i));
                     }
                     break;
                  } // end if: equals sign
