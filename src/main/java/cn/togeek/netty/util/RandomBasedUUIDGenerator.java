...
class RandomBasedUUIDGenerator implements UUIDGenerator {
   ...
   /**
    * Returns a Base64 encoded version of a Version 4.0 compatible UUID randomly
    * initialized by the given {@link java.util.Random} instance as defined
    * here: http://www.ietf.org/rfc/rfc4122.txt
    */
   public String getBase64UUID(Random random) {
       ...
       * The randomly or pseudo-randomly generated version. The version number
       * is in the most significant 4 bits of the time stamp (bits 4 through 7
       * of the time_hi_and_version field).
       */
      randomBytes[6] &=
         0x0f; /* clear the 4 most significant bits for the version */
      ...
      try {
         byte[] encoded =
            Base64.encodeBytesToBytes(randomBytes, 0, randomBytes.length,
               Base64.URL_SAFE);
